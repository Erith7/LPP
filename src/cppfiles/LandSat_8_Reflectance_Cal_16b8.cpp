...
//=========================================================================================
    ...
    dimage1.release();
    Mat dimage11;	
    image11.convertTo(dimage11,CV_16UC1,255.0);
    image11.release();
    imwrite(OutputImagesB2,dimage11);
    dimage11.release();
//=========================================================================================
...
//=========================================================================================
    ...
    dimage2.release();	
    Mat dimage22;	
    image22.convertTo(dimage22,CV_16UC1,255.0);
    image22.release();
    imwrite(OutputImagesB3,dimage22);
    dimage22.release();
//=========================================================================================
...
//=========================================================================================
    ...
    dimage3.release();	
    Mat dimage33;	
    image33.convertTo(dimage33,CV_16UC1,255.0);
    image33.release();
    imwrite(OutputImagesB4,dimage33);
    dimage33.release();
//=========================================================================================
...
//=========================================================================================
    ...
    dimage4.release();	
    Mat dimage44;	
    image44.convertTo(dimage44,CV_16UC1,255.0);
    image44.release();
    imwrite(OutputImagesB5,dimage44);
    dimage44.release();
//=========================================================================================
...
//=========================================================================================
    ...
    dimage5.release();	
    Mat dimage55;	
    image55.convertTo(dimage55,CV_16UC1,255.0);
    image55.release();
    imwrite(OutputImagesB6,dimage55);
    dimage55.release();
//=========================================================================================
...
//=========================================================================================
    ...
    dimage6.release();	
    Mat dimage66;	
    image66.convertTo(dimage66,CV_16UC1,255.0);
    image66.release();
    imwrite(OutputImagesB7,dimage66);
    dimage66.release();
//=========================================================================================
...
//=========================================================================================
    ...
    dimage7.release();	
    Mat dimage77;	
    image77.convertTo(dimage77,CV_16UC1,255.0);
    image77.release();
    imwrite(OutputImagesB9,dimage77);
    dimage77.release();
