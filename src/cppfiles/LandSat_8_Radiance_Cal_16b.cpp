...
|Compilation Comand: g++ -std=c++11 -o LandSat_8_Radiance_Cal_16b.exe LandSat_8_Radiance_Cal_16b.cpp $(pkg-config opencv --libs)
...
int main (int argc, char *argv[])
{
  ...
  if (argc != 4)
    cout << "Uso: ./LandSat_8_Radiance_Cal_8b.exe ruta_directorio nombre_imagen_banda_1 ruta_output\n";
  else
    {
	...
	parameters_file.open(Outputtxt);
        ...
        parameters_file.close();
            ...
            string MultiBand2="";
            size_t pch2;
            pch2=line.find("RADIANCE_MULT_BAND_2 = ");
            if(pch2 != string::npos)
            {
            int counter=pch2+23;
            ...
            string AddBand2="";
            size_t pch2A;
            pch2A=line.find("RADIANCE_ADD_BAND_2 = ");
            if(pch2A != string::npos)
            {
            int counter=pch2A+22;
            ...
            string MultiBand3="";
            size_t pch3;
            pch3=line.find("RADIANCE_MULT_BAND_3 = ");
            if(pch3 != string::npos)
            {
            int counter=pch3+23;
            ...
            string AddBand3="";
            size_t pch3A;
            pch3A=line.find("RADIANCE_ADD_BAND_3 = ");
            if(pch3A != string::npos)
            {
            int counter=pch3A+22;
            ...
            string Multiband4="";
            size_t pch4;
            pch4=line.find("RADIANCE_MULT_BAND_4 = ");
            if(pch4 != string::npos)
            {
            int counter=pch4+23;
            ...
            string Addband4="";
            size_t pch4A;
            pch4A=line.find("RADIANCE_ADD_BAND_4 = ");
            if(pch4A != string::npos)
            {
            int counter=pch4A+22;
            ...
            string Multiband5="";
            size_t pch5;
            pch5=line.find("RADIANCE_MULT_BAND_5 = ");
            if(pch5 != string::npos)
            {
            int counter=pch5+23;
            ...
            string Addband5="";
            size_t pch5A;
            pch5A=line.find("RADIANCE_ADD_BAND_5 = ");
            if(pch5A != string::npos)
            {
            int counter=pch5A+22;
            ...
            string Multiband6="";
            size_t pch6;
            pch6=line.find("RADIANCE_MULT_BAND_6 = ");
            if(pch6 != string::npos)
            {
            int counter=pch6+23;
            ...
            string Addband6="";
            size_t pch6A;
            pch6A=line.find("RADIANCE_ADD_BAND_6 = ");
            if(pch6A != string::npos)
            {
            int counter=pch6A+22;
            ...
            string Multiband7="";
            size_t pch7;
            pch7=line.find("RADIANCE_MULT_BAND_7 = ");
            if(pch7 != string::npos)
            {
            int counter=pch7+23;
            ...
            string Addband7="";
            size_t pch7A;
            pch7A=line.find("RADIANCE_ADD_BAND_7 = ");
            if(pch7A != string::npos)
            {
            int counter=pch7A+22;
            ...
            string Multiband9="";
            size_t pch9;
            pch9=line.find("RADIANCE_MULT_BAND_9 = ");
            if(pch9 != string::npos)
            {
            int counter=pch9+23;
            ...
            string Addband9="";
            size_t pch9A;
            pch9A=line.find("RADIANCE_ADD_BAND_9 = ");
            if(pch9A != string::npos)
            {
            int counter=pch9A+22;
    ...
    cout<<"Prueba"<<"MB2=  "<<MB2*2<<endl;
    cout<<"Prueba"<<"A2=  "<<A2*2<<endl;
    cout<<"Prueba"<<"angle=  "<<2*angle<<endl;
	...
	image11=255*(image11-minVal11)/(maxVal11-minVal11);//65536
